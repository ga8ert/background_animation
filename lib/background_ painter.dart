...
import 'package:ten/config/color.dart';
...
class BackgroundPainter extends CustomPainter{
  ...
  BackgroundPainter({
    Animation<double> animation
      ...
      :bluePaint = Paint()
        ..color = ApplicationColor.lightBlue
        ..style = PaintingStyle.fill,
      greyPaint = Paint()
        ..color = ApplicationColor.darkBlue
        ..style = PaintingStyle.fill,
      orangePaint = Paint()
  ...
  void paintBlue(Canvas canvas, Size size){
    ...
    _addPointsToPath(path, [
      ...
      Point(size.width, lerpDouble(size.height/2, size.height/4*3, liquidAnim.value), ),
    ]);
